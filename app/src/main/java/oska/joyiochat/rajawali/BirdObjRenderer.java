...
public class BirdObjRenderer extends Renderer {
    ...
    public BirdObjRenderer(Context context) {
        super(context);
    }
    ...
    protected void initScene() {
        ...
        LoaderOBJ objParser = new LoaderOBJ(mContext.getResources(),
                mTextureManager, R.raw.bird_obj);
        try {
            objParser.parse();
