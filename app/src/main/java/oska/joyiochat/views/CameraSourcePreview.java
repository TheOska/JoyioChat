...
public class CameraSourcePreview extends ViewGroup {
    ...
    public CameraSourcePreview(Context context, AttributeSet attrs) {
        ...
        Log.v(TAG,"Type conversion constructor called");
    }
    ...
    private void startIfReady() throws IOException {
        if (mStartRequested && mSurfaceAvailable) {
            ...
            // control the surface size and format, edit the pixels in the surface, and monitor changes to the surface.
    ...
    // To receive information about changes to the surface
